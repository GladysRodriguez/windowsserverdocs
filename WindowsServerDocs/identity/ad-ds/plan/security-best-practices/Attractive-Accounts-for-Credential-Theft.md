...
Because highly privileged accounts in Active Directory can be used to propagate compromise and to manipulate VIP accounts or the data that they can access, the most useful accounts for credential theft attacks are accounts that are members of Enterprise Admins, Domain Admins, and Administrators groups in Active Directory. A list of other accounts that have high privilege are the [Tier 0 Equivalent Accounts](https://docs.microsoft.com/en-us/windows-server/identity/securing-privileged-access/securing-privileged-access-reference-material#T0E_BM).  
...
Other systems that an attacker may target are the [Information Security systems] (https://blogs.technet.microsoft.com/johnla/2016/02/20/how-infosec-security-controls-create-vulnerability/) used to protect the environment.  For example, targeting the backup systems or storage systems for backups may enable access to offline copies of the AD DS database. Or perhaps, targeting systems or accounts that are used to perform network wide configuration may be target to quickly spread malware or other malicious code. To protect the environment, [defenders must think in graph](https://blogs.technet.microsoft.com/johnla/2015/04/26/defenders-think-in-lists-attackers-think-in-graphs-as-long-as-this-is-true-attackers-win/).
